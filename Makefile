...
#	Makefile for QFlow of sample project "booth_multiplier", target tech. ETRI 0.5um CMOS
#
...
all :
	@echo 'Makefile for "booth_multiplier" QFlow RTL-to-Layout using ETRI 0.5um CMOS Technology'
